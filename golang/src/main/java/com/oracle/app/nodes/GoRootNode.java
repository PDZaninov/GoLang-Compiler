...
/**
 * The root of all Go execution trees. It is a Truffle requirement that the tree root extends the
 * class {@link RootNode}. This class is used for both builtin and user-defined functions. For
 * builtin functions, the {@link #bodyNode} is a subclass of {@link GoBuiltinNode}. For user-defined
 * functions, the {@link #bodyNode} is a {@link GoFunctionBodyNode}.
 */
